...
public class VisionTarget extends CommandBase {
    ...
    protected void execute() {
        double xout = camera.cogx();
        double yout = camera.cogy();
        double boxsize = camera.boxsize();
        double dist = camera.computeDistance(true, boxsize);
        ////DriverStationLCD.getInstance().println(//DriverStationLCD.Line.kUser6, 1, "X:"+xout+"Y:"+yout+ "BOX:"+boxsize);
